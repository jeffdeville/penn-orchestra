...
public class SystemStartTest {
	...
	public void startupTest() throws Exception {
		...
		if (os.startsWith("Windows")) {
			Config
					.setUpdateStoreExecutable(new String[] { "../engine/target/updateStore/bin/updateStore.bat" });
		} else {
			// Script generated by Maven is not executable.
			Config.setUpdateStoreExecutable(new String[] { "sh",
					"../engine/target/updateStore/bin/updateStore" });
		}
	...
	public void cleanUp() throws Exception {
		...
		try {
			...
			//Need to be able to shut down US even if system is null.
