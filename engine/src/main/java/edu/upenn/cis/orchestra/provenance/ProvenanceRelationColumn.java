 ...
 *
 */
public class ProvenanceRelationColumn {
	public ProvenanceRelationColumn(RelationField col, boolean inx, int previous, List<RelationField> src,
			List<RelationField> dist, AtomArgument srcVar) {
		setColumn(col);
		setIndex(inx);
		setSpecialAttr(false);
	...
	public ProvenanceRelationColumn(RelationField col, boolean inx, int previous, List<RelationField> src,
			List<RelationField> dist, AtomArgument srcVar, boolean isSpecialAttr) {
		this(col, inx, previous, src, dist, srcVar);
		setSpecialAttr(isSpecialAttr);
	}
	/**
	...
	/**
	 * @param isSpecialAttr the isSpecialAttr to set
	 */
	public void setSpecialAttr(boolean isSpecialAttr) {
		this.isSpecialAttr = isSpecialAttr;
	}
	/**
	 * @return the isSpecialAttr
	 */
	public boolean isSpecialAttr() {
		return isSpecialAttr;
	}
	/**
